...
- (void)initData{
    ...
    surpportBtn.layer.shouldRasterize = YES;
    surpportBtn.layer.rasterizationScale = [UIScreen mainScreen].scale;
    ...
    appointBtn.layer.shouldRasterize = YES;
    appointBtn.layer.rasterizationScale = [UIScreen mainScreen].scale;
