...
REGULAREXPRESSION(SlashEmojiRegularExpression,@"\\[\\w\\w_\\d+\\]")
//                  @"\\[[a-zA-Z0-9\\u4e00-\\u9fa5]+\\]")
...
- (void)commonInit {
    ...
    UIColor *commonLinkColor = userNameColor;
...
- (NSMutableAttributedString*)mutableAttributeStringWithEmojiText:(NSAttributedString *)emojiText
{
    ...
    //    [attrStr addAttribute:NSForegroundColorAttributeName value:[UIColor yellowColor] range:NSMakeRange(6,3)];
    return attrStr;
}
