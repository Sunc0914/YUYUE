...
- (UIColor *)indicatorColor {
    if (!_indicatorColor) {
        _indicatorColor = [UIColor colorWithRed:200/255.0 green:200/255.0 blue:200/255.0 alpha:1.0];
    }
...
- (UIColor *)textColor {
    if (!_textColor) {
        _textColor = [UIColor colorWithRed:130/255.0 green:130/255.0 blue:130/255.0 alpha:1.0];
    }
    return _textColor;
}
...
- (UIColor *)separatorColor {
    if (!_separatorColor) {
        _separatorColor = [UIColor colorWithRed:200/255.0 green:200/255.0 blue:200/255.0 alpha:1.0];
    }
...
//    CGFloat separatorLineInterval = self.frame.size.width / _numOfMenu;
    ...
    for (int i = 0; i < _numOfMenu; i++) {
        //bgLayer
        CGPoint bgLayerPosition = CGPointMake((i+0.5)*bgLayerInterval-5, self.frame.size.height/2);
...
- (CAShapeLayer *)createIndicatorWithColor:(UIColor *)color andPosition:(CGPoint)point {
    ...
    [path addLineToPoint:CGPointMake(6, 1)];
    [path addLineToPoint:CGPointMake(9, 0)];
    [path addLineToPoint:CGPointMake(12, 0)];
    [path addLineToPoint:CGPointMake(6, 2.5)];
    [path closePath];
